...
export default function Footer() {
  return (
    <section className="relative w-full bg-secondary text-white overflow-hidden h-auto lg:h-[55vh]" data-theme="dark">
      
      {/* Sticky Footer Panel - static on mobile, fixed reveal on desktop */}
      <div className="relative lg:fixed lg:bottom-0 w-full h-auto lg:h-[55vh] flex flex-col justify-between pt-16 pb-8 px-6 md:px-16 bg-[#070606] lg:bg-transparent pointer-events-auto lg:pointer-events-none">
        
        {/* Footer Top Content */}
        <div className="flex flex-col md:flex-row justify-between items-start w-full pointer-events-auto max-w-7xl mx-auto z-10 gap-10 md:gap-0">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-[9px] uppercase tracking-wider text-white/40 border-t border-white/5 pt-8 pb-4 max-w-7xl mx-auto z-10 pointer-events-auto mt-10 lg:mt-0">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center text-[9px] md:text-[10px] uppercase tracking-widest text-white/30 pointer-events-auto border-t border-white/5 pt-6 max-w-7xl mx-auto z-10 gap-4 mt-6 lg:mt-0">
